...
function Extend(base,       // @arg Object/Function: base object.
                ...
                override) { // @arg Boolean(= false): true is override.
                            // @help: Extend
//{@assert
    _if(!_isObject(base) && !_isFunction(base), "invalid Extend(base)");
...
Extend["define"] = Extend_define; // Extend.define(base:Object/Function, key:String, value:Any, override:Boolean = false):void
Extend["mixin"]  = Extend_mixin;  // Extend.mixin(base:Object/Function, extend:Object, override:Boolean = false):Object/Function
...
function Extend_define(base,       // @arg Object/Function:
                       key,        // @arg String:
                       value,      // @arg Any:
...
//{@assert
    _if(!_isObject(base) && !_isFunction(base), "invalid Extend.define(base)");
...
function Extend_mixin(base,       // @arg Object/Function: base object
                      ...
                      override) { // @arg Boolean(= false):
                                  ...
                                  // @desc: Mixin object.
//{@assert
    _if(!_isObject(base) && !_isFunction(base), "invalid Extend.mixin(base)");
